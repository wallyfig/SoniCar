...
public class MainActivity extends AppCompatActivity {
    private final String DEVICE_ADDRESS = "B8:27:EB:6D:EC:6F"; //MAC Address of Bluetooth Module
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN)
                {
                    ...
                    //while (true) {
                        try {
                            ...
                            Log.e("",s);     // Send to message queue Handler
                        } catch (IOException e) {
                            Log.e("","error getting data");
                            //break;
                        }
                    //}
                    command = "2";
